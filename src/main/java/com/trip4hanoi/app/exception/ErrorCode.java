...
public enum ErrorCode {
    ...
    // CHAT ERRORS
    BOX_CHAT_NOT_FOUND(1020, "Box chat not found", HttpStatus.NOT_FOUND),
    ...
    NOT_FOUND_BOX_PARTICIPANT (1023, "Box participant not found", HttpStatus.NOT_FOUND),
    USER_ALREADY_IN_BOX (1024, "User is already in box", HttpStatus.BAD_REQUEST),
    USER_NOT_FOUND_IN_BOX (1025, "User not found in box", HttpStatus.NOT_FOUND);
